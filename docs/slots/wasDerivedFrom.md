...
- AnonymousSlotExpression({'range': 'Item'})
- AnonymousSlotExpression({'range': 'ItemGroup'})
- AnonymousSlotExpression({'range': 'MetaDataVersion'})
- AnonymousSlotExpression({'range': 'CodeList'})
- AnonymousSlotExpression({'range': 'ReifiedConcept'})
- AnonymousSlotExpression({'range': 'ConceptProperty'})
- AnonymousSlotExpression({'range': 'Condition'})
- AnonymousSlotExpression({'range': 'Method'})
- AnonymousSlotExpression({'range': 'NominalOccurrence'})
- AnonymousSlotExpression({'range': 'Dataflow'})
- AnonymousSlotExpression({'range': 'CubeComponent'})
- AnonymousSlotExpression({'range': 'DataProduct'})
- AnonymousSlotExpression({'range': 'ProvisionAgreement'})
